  ...
  <div class="min-vh-100 d-flex flex-column justify-content-center align-items-center bg-site">
    <b-card class="w-100 shadow-sm border-0 px-3 py-4 card-bg" style="max-width: 380px">
      <div class="text-center mb-3">
        ...
        <h5 class="mt-2">Добро пожаловать</h5>
        <p class="text-muted mb-0">Войдите в свой аккаунт</p>
      </div>

      <b-form @submit.prevent="handleLogin">
        <b-form-group label="Email" label-for="email" class="d-block my-2">
          <b-form-input
              id="email"
              v-model="email"
              type="email"
        ...
        <b-form-group label="Пароль" label-for="password" class="d-block my-2">
          <b-form-input
              id="password"
              v-model="password"
              type="password"
      ...
      <p class="text-center text-muted mt-3 mb-0" style="font-size: 0.9rem;">
        Нет аккаунта?
        <NuxtLink to="/sign-up" class="text-primary text-decoration-none">
          Зарегистрируйтесь
        </NuxtLink>
      </p>
    </b-card>
