<template>
  <div>
    ...
    <div v-if="genres.length === 0" class="text-muted small">Загрузка...</div>
    ...
    <div v-else class="d-flex flex-wrap gap-2">
      ...
      >
        ...
        />
        <label class="form-check-label text-capitalize" :for="genre">
          {{ genre.replaceAll('_', ' ') }}
        </label>
      </div>
    </div>

    <div v-if="genres.length !== 0" class="mt-4 d-flex">
      <button
